...
def add_io_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:  # pragma: no cover
    ...
    parser.add_argument("--data_files", type=str, help="input data files. contains glob pattern {}."),
    parser.add_argument("--offset", type=int, help="offset to glob pattern."),
    parser.add_argument("--nfiles", type=int, help="# of files to read from `data_files`"),
    ...
    parser.add_argument("--file", type=str, help="jsonl.zstd file"),
